...
Filter.prototype.xssReplacement = function(replacement) {
    this.xssReplacement = replacement;
}

Filter.prototype.xss = function(is_image) {
    this.modify(xss.clean(this.str, is_image, (typeof this.xssReplacement === 'undefined' ? '[removed]' : this.xssReplacement));
